...
dir <- "D:/Users/Jordan-Epi/Documents/Epi_2016-17/03_Irbid/02_Cohort_Analysis/Iraq/Kirkuk Oct"
setwd(dir)
#5 loads files
patientIRAQ <- read.delim("D:/Users/Jordan-Epi/Documents/Epi_2016-17/03_Irbid/02_Cohort_Analysis/Iraq/Kirkuk Oct/patientIRAQ.txt",stringsAsFactors=FALSE)
visitIRAQ <- read.delim("D:/Users/Jordan-Epi/Documents/Epi_2016-17/03_Irbid/02_Cohort_Analysis/Iraq/Kirkuk Oct/visitIRAQ.txt",stringsAsFactors=FALSE)
labIRAQ <- read.delim("D:/Users/Jordan-Epi/Documents/Epi_2016-17/03_Irbid/02_Cohort_Analysis/Iraq/Kirkuk Oct/labIRAQ.txt",stringsAsFactors=FALSE)
#6 installs packages
...
Total_Hyp <- visitP[visitP$Hypertension.x == 1 & visitP$Admission.date <Firstday & visitP$Date.of.exit >Exitday & visitP$Date.of.visit <Firstday,]
...
Total_DM2_denom_N <-NROW(Total_DM2_max) 
#from this selection it selects the diabetics that had urine dipstick recorded (many did dipstick but have no DM2) 
...
(perc_DM2_urinedipsticktest<-(Total_Microalbumin_denom_N/Total_DiabetesII_denom_N))

#---------------------------------------------------------------------------------------------------------------------#
# Number / % of DM patients that have HbA1c testing in the last period (3 months/year)
# Note: no HbA1C data available yet as of 2017/10
Firstday <- "2017-10-01"
Firstday <- as.Date(Firstday)
Exitday <- "2017-08-31"
Exitday <- as.Date(Exitday)
...
(perc_DM2_HbA1C<-(Total_HbA1C_denom_N/Total_DiabetesII_denom_N))

#---------------------------------------------------------------------------------------------------------------------#
# Number / % of patients with DM or on ACE inhibitor (ACEi) with Creatinine testing in last year 
# Note: no creatine data available yet as of 2017/10
Firstday <- "2017-10-01" # Note that this is the upper limit and Exitday is the lower limit
Firstday <- as.Date(Firstday)
Exitday <- "2017-08-01"
Exitday <- as.Date(Exitday) 
